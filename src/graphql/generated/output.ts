...
export type CreateUserMutation = { createUser: { success: boolean, token: string } };
...
export type FindRecommendedChannelsQuery = { findRecommendedChannels: Array<{ username: string, avatar: string | null, isVerified: boolean, streams: { isLive: boolean } | null }> };
...
export type FindNotificationsByUserQuery = { findNotificationsByUser: Array<{ id: string, message: string, type: NotificationType, createdAt: unknown }> };
